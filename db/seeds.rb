...
Sap::Store.create([
  ...
  {id:5,  name: 'Перекресток',  order_pos: 5, url: 'perekrestok',   region_id: 1},
])
...
Sap::GoodItem.create([
                       # Azbuka Vkusa
                       {id: 1,  good_id: 1,  price: 30.00, store_id: 2, store_gid: 1},
                       {id: 2,  good_id: 2,  price: 29.80, store_id: 2, store_gid: 2},
                       {id: 3,  good_id: 3,  price: 31.50, store_id: 2, store_gid: 3},
                       {id: 4,  good_id: 4,  price: 50.00, store_id: 2, store_gid: 4},
                       {id: 5,  good_id: 5,  price: 60.00, store_id: 2, store_gid: 5},
                       {id: 6,  good_id: 6,  price: 550.0, store_id: 2, store_gid: 6},
                       {id: 7,  good_id: 7,  price: 250.0, store_id: 2, store_gid: 7},
                       {id: 8,  good_id: 8,  price: 900.0, store_id: 2, store_gid: 8},
                       {id: 9,  good_id: 9,  price: 37.00, store_id: 2, store_gid: 9},
                       {id: 10, good_id: 10, price: 36.00, store_id: 2, store_gid: 10},
                       {id: 11, good_id: 11, price: 33.50, store_id: 2, store_gid: 11},
                       {id: 12, good_id: 12, price: 35.00, store_id: 2, store_gid: 12},
                       {id: 13, good_id: 13, price: 850.0, store_id: 2, store_gid: 13},
                       {id: 14, good_id: 14, price: 500.0, store_id: 2, store_gid: 14},
                       {id: 15, good_id: 15, price: 990.0, store_id: 2, store_gid: 15},
                       {id: 16, good_id: 16, price: 150.0, store_id: 2, store_gid: 16},
                       {id: 17, good_id: 17, price: 50.00, store_id: 2, store_gid: 17},
                       {id: 18, good_id: 18, price: 250.0, store_id: 2, store_gid: 18},
                       {id: 19, good_id: 19, price: 90.00, store_id: 2, store_gid: 19},

                       # Allye Parusa
                       {id: 21, good_id: 1,  price: 31.00, store_id: 3, store_gid: 1},
                       {id: 22, good_id: 2,  price: 29.80, store_id: 3, store_gid: 2},
                       {id: 23, good_id: 3,  price: 35.50, store_id: 3, store_gid: 3},
                       {id: 24, good_id: 4,  price: 54.00, store_id: 3, store_gid: 4},
                       {id: 25, good_id: 5,  price: 61.00, store_id: 3, store_gid: 5},
                       {id: 26, good_id: 6,  price: 559.0, store_id: 3, store_gid: 6},
                       {id: 27, good_id: 7,  price: 251.0, store_id: 3, store_gid: 7},
                       {id: 28, good_id: 8,  price: 700.0, store_id: 3, store_gid: 8},
                       {id: 29, good_id: 9,  price: 47.00, store_id: 3, store_gid: 9},
                       {id: 30,good_id: 10, price: 46.00, store_id: 3, store_gid: 10},
                       {id: 31,good_id: 11, price: 43.50, store_id: 3, store_gid: 11},
                       {id: 32,good_id: 12, price: 45.00, store_id: 3, store_gid: 12},
                       {id: 33,good_id: 13, price: 950.0, store_id: 3, store_gid: 13},
                       {id: 34,good_id: 14, price: 600.0, store_id: 3, store_gid: 14},
                       {id: 35,good_id: 15, price: 900.0, store_id: 3, store_gid: 15},
                       {id: 36,good_id: 16, price: 170.0, store_id: 3, store_gid: 16},
                       {id: 37,good_id: 17, price: 55.00, store_id: 3, store_gid: 17},
                       {id: 38,good_id: 18, price: 230.0, store_id: 3, store_gid: 18},
                       {id: 39,good_id: 19, price: 91.00, store_id: 3, store_gid: 19},
                     ])
...
customer = Sap::Customer.new do |c|
  ...
  c.user = Sap::User.new do |user|
    ...
    user.salt = 'asd123'
    user.password =  Digest::MD5.hexdigest( Digest::MD5.hexdigest('user'))
...
admin = Sap::Admin.new do |a|
  ...
  a.user = Sap::User.new do |user|
    ...
    # Set Random password and Salt
    user.salt = 'qwe123'
    user.password = Digest::MD5.hexdigest( Digest::MD5.hexdigest('admin'))
...
Sap::Order.create(id:1, state: Sap::Order::STATES[:STATE_NEW], hash_str: 'uy23ed' )
